...
## Project Structure
    ...
    ├── bouyela_education_c_42612  # Django project configurations
...
1. Clone this repo and `cd bouyela_education_c_42612`
...
2. Clone this repo and `cd bouyela_education_c_42612`
